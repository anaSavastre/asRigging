...
class foot(object):
    ...
    def footRoll_setUp(self, footJNTList=[], parent=None):
        ...
        animBlend = mNode.animBlendNodeAdditiveDA(side=self.side, name="footRoll"+"ankleAddingRotationX")
        mmod.connectAttr(decompMtxAnkeCtl.name+".outputRotateX", animBlend.getInputA())
